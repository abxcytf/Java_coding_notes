...
write a program to output the skyline formed by these buildings collectively (Figure B).
 ...
 Buildings  Skyline Contour, always be the start point
The geometric information of each building is represented by a triplet of 
integers [Li, Ri, Hi], where Li and Ri are the x coordinates of the left and right 
edge of the ith building, respectively, and Hi is its height. It is guaranteed 
...
public class Solution {
    public List<int[]> getSkyline(int[][] buildings) {
        ...
        //store each start and end point
        for (int[] building : buildings) {
            //to distinguish the start and end point with neg/pos height
            //neg height is start point, pos height is end point
            heights.add(new int[] {building[0], -building[2]});
            heights.add(new int[] {building[1], building[2]});
        }
        
        //Here we need to sort the height according the start point and height
