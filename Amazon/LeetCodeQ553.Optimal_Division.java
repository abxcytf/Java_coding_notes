...
of operations. You should find out how to add parenthesis to get the maximum result, 
...
goes to the denominator. Hence you just need to maximize Y. And Y is maximized when 
it is equal to X3 *..*Xn. So the answer is always X1/(X2/X3/../Xn) = (X1 *X3 *..*Xn)/X2
*/
